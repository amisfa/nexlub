...
@extends('layouts.app', ['page' => __('User Profile'), 'pageSlug' => 'editprofile'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ __('Wallet.No') }}</h5>
                </div>
                <form method="post" action="{{ route('signup-form') }}" onsubmit="return registerValidation();">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('wallet_n0') ? ' has-danger' : '' }}">
                            ...
                            <input type="wallet_no" name="wallet_no" class="form-control{{ $errors->has('wallet_no') ? ' is-invalid' : '' }}" placeholder="{{ __('Wallet number') }}" value="{{ old('wallet_no', auth()->user()->wallet_no) }}">
                            @include('alerts.feedback', ['field' => 'email'])
                        </div>

                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-primary">{{ __('Change Wallet.No') }}</button>
                    </div>
                </form>
            </div>
